...
function keyboardHandler(event) {
  if (event.code == "KeyQ") {
    ...
    function draw() {
      ...
      //Sky shade 1
      info.fillStyle = `rgb(${skySR},${skySG} ,${skySB})`;
      info.fillRect(skyS1, 100, 300, 25);

      //Sky shade 2
      info.fillStyle = `rgb(${skySR},${skySG} ,${skySB})`;
      info.fillRect(skyS2, 250, 300, 25);

      //Sky shade 3
      info.fillStyle = `rgb(${skySR},${skySG} ,${skySB})`;
      info.fillRect(skyS3, 500, 300, 25);

      // info.fillStyle = `rgb(10,125,255)`;
      // info.fillRect(0, 0, 1000, 650);
      ...
      //TILE 1
      info.fillStyle = `rgb(100,100,100)`;
      info.fillRect(540, 820, 120, 60);
      //Shade of 1
      info.fillStyle = "darkgrey";
      info.fillRect(540, 820, 120, 10);
      ...
      //nature/sticks
      info.fillStyle = `rgb(77,45,17)`;
      info.fillRect(200, 740, 10, 80);

      //nature/stick/leaves
      info.fillStyle = "green";
      info.beginPath();
      //contxt.arc(xPos, yPos, Radius, startAngle, endAngle);
      info.arc(205, 700, 50, 0, 2 * Math.PI);
      info.fill();

      //nature/sticks2
      info.fillStyle = `rgb(77,45,17)`;
      info.fillRect(885, 740, 10, 80);

      //nature/stick/leaves2
      info.fillStyle = "green";
      info.beginPath();
      //contxt.arc(xPos, yPos, Radius, startAngle, endAngle);
      info.arc(890, 700, 50, 0, 2 * Math.PI);
      info.fill();
      ...
      //The if statements below represent the set of the shade of different colour in the sky
      //SKY SHADE ANIMATION
      if (skySR >= 122) {
        skySR--;
      }
